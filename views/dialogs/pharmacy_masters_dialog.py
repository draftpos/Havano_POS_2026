...
class PharmacyMastersDialog(QDialog):
    ...
    def _build_doctors_tab(self):
        ...
        if get_system_mode().lower() == "offline":
            self._doctor_refresh.setVisible(False)
    ...
    def _build_dosages_tab(self):
        ...
        if get_system_mode().lower() == "offline":
            self._dosage_refresh.setVisible(False)
    ...
    def _on_new_doctor(self):
        ...
        try:
            ...
            print(f"[PharmacyMasters] [OK] Created doctor locally id={new_id} "
    ...
    def _on_edit_doctor(self, *_):
        ...
        try:
            ...
            print(f"[PharmacyMasters] [OK] Updated doctor id={doc.id} "
                  f"name='{data.get('full_name')}'")
        except Exception as e:
    ...
    def _on_new_dosage(self):
        ...
        try:
            ...
            print(f"[PharmacyMasters] [OK] Created dosage locally id={new_id} "
    ...
    def _on_edit_dosage(self, *_):
        ...
        try:
            ...
            print(f"[PharmacyMasters] [OK] Updated dosage id={dos.id} "
                  f"code='{data.get('code')}'")
        except Exception as e:
