...
#             print(f"   [OK] Default customer already exists (ID: {customer_id})")
#             if frappe_synced:
#                 print(f"   [OK] Already synced with Frappe")
#             else:
#                 print(f"   [!]  Exists but not synced with Frappe - will trigger sync")
#                 # Trigger sync for existing unsynced customer
#                 sync_result = _trigger_frappe_sync(cursor, conn, customer_id)
#                 if sync_result:
#                     print(f"   [OK] Successfully synced existing customer!")
#                 else:
#                     print(f"   [!]  Will retry sync later via background thread")
#             print("\n" + "="*60)
...
#         print(f"   [OK] Default customer created! (ID: {customer_id})")
...
#         if push_success:
#             print(f"   [OK] Successfully pushed to Frappe!")
#         else:
#             print(f"   [!]  Will be synced when Frappe is available")
...
#         print(f"   [!]  No API credentials available from credentials service")
#         return False
    
#     if not base_url:
#         print(f"   [!]  No Frappe host configured in site_config")
#         return False
