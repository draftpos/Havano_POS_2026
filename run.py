# =============================================================================
# install_models.py  —  Run this ONCE from your project root.
# It writes all required model files directly into models/
# Usage:  python install_models.py
# =============================================================================
import os, sys
...
# ─────────────────────────────────────────────────────────────────────────────
FILES["price_list.py"] = '''# models/price_list.py
...
# ─────────────────────────────────────────────────────────────────────────────
FILES["company.py"] = '''# models/company.py
from database.db import get_connection, fetchall_dicts, fetchone_dict
...
# ─────────────────────────────────────────────────────────────────────────────
FILES["customer_group.py"] = '''# models/customer_group.py
from database.db import get_connection, fetchall_dicts, fetchone_dict
...
# ─────────────────────────────────────────────────────────────────────────────
FILES["warehouse.py"] = '''# models/warehouse.py
from database.db import get_connection, fetchall_dicts, fetchone_dict
...
# ─────────────────────────────────────────────────────────────────────────────
FILES["cost_center.py"] = '''# models/cost_center.py
from database.db import get_connection, fetchall_dicts, fetchone_dict
...
# ─────────────────────────────────────────────────────────────────────────────
FILES["customer.py"] = '''# models/customer.py
from database.db import get_connection, fetchall_dicts, fetchone_dict
...
# WRITE ALL FILES
# ─────────────────────────────────────────────────────────────────────────────
print("\n  Havano POS — Installing model files into models/")
print("=" * 50)
...
print("=" * 50)
print("  🎉  Done. Run:  py seed_all.py  then  py main.py")
print()