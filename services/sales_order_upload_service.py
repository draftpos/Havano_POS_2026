# # # =============================================================================
# # # services/sales_order_upload_service.py  —  Push local Sales Orders → ERPNext
# # #
# # # Mirrors the structure of pos_upload_service.py.
# # # Pushes to /api/resource/Sales Order  (docstatus=0 = Draft, or 1 = Submitted)
# # # Rate-limited: max 20 orders/minute.
# # # =============================================================================
...
# # REQUEST_TIMEOUT  = 30
# # MAX_PER_MINUTE   = 20
# # INTER_PUSH_DELAY = 60 / MAX_PER_MINUTE   # 3 s


# # # =============================================================================
# # # JSON encoder — handles datetime/date
# # # =============================================================================
...
# #     Returns None if no valid items (caller will skip this order).
# #     """
# #     frappe_items = []
...
# #             "delivery_date": order.get("order_date") or date.today().isoformat(),
# #         }
# #         if warehouse:
...
# #     payload = {
# #         "doctype":        "Sales Order",
# #         "docstatus":      0,           # Draft — change to 1 to auto-submit
# #         "customer":       customer,
...
# #     # Advance / deposit — ERPNext records this on a Payment Entry later,
# #     # but we can attach a note for the operator.
...
# #         True — permanent skip (data error, already exists)
...
# # # =============================================================================
# # # PUBLIC — push all unsynced orders
# # # =============================================================================
...
# #             log.info("Rate limit pause — waiting 60s…")
# #             time.sleep(60)
...
# #     log.info("Sales Order upload done — ✅ %d pushed  ❌ %d failed  (of %d)",
# #              result["pushed"], result["failed"], result["total"])
# #     return result


# # # =============================================================================
# # # QThread worker  (same pattern as UploadWorker)
# # # =============================================================================
...
# #     """Start the Sales Order upload background thread. Call once from MainWindow."""
# #     try:
...
#
# Mirrors the structure of pos_upload_service.py.
# Pushes to /api/resource/Sales Order
# Rate-limited: max 20 orders/minute.
#
# v2 fixes:
#   - docstatus set to 1 (Submitted) so orders are not left as Draft
#   - delivery_date now uses the actual delivery_date stored on the order
#     instead of falling back to order_date
#   - reserve_stock = 1 added so stock is reserved on submit
# =============================================================================
