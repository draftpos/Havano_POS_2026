...
# -- =============================================================================
# -- Migration: Add terms_and_conditions to company_defaults
...
#     WHERE  TABLE_NAME  = 'company_defaults'
#     AND    COLUMN_NAME = 'terms_and_conditions'
# )
# BEGIN
#     ALTER TABLE company_defaults
#         ADD terms_and_conditions NVARCHAR(MAX) NOT NULL
#             CONSTRAINT DF_company_defaults_terms DEFAULT '';

#     PRINT 'Column terms_and_conditions added successfully.';
# END
# ELSE
# BEGIN
#     PRINT 'Column terms_and_conditions already exists — nothing to do.';
# END